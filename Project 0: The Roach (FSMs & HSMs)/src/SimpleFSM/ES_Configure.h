...
//#define POSTFUNCTION_FOR_KEYBOARD_INPUT PostFSM
...
#define TIMER0_RESP_FUNC PostService
#define TIMER1_RESP_FUNC PostFSM
...
#if NUM_SERVICES > 1
// the header file with the public fuction prototypes
#define SERV_1_HEADER "FSM.h"
// the name of the Init function
#define SERV_1_INIT InitFSM
// the name of the run function
#define SERV_1_RUN RunFSM
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "Service.h"
// the name of the Init function
#define SERV_2_INIT InitService
// the name of the run function
#define SERV_2_RUN RunService
// How big should this services Queue be?
